...
void CBMonsterS1::Initialize()
{
    CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Monster/ZENCHAN_Right.bmp",L"ZENCHAN_Right");
    CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Monster/ZENCHAN_Left.bmp",L"ZENCHAN_Left");
    CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Monster/ZENCHAN_Death.bmp",L"ZENCHAN_Death");
    CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Monster/ZENCHAN_Bubble.bmp",L"ZENCHAN_Bubble");
	m_pFrameKey = L"ZENCHAN_Left";
...
void CBMonsterS1::Late_Update()
{
	Move_Frame();
	motion_Change();
}

void CBMonsterS1::Render(HDC hDC)
{
...
void CBMonsterS1::Release()
{
}

void CBMonsterS1::motion_Change()
{
